...
public class WebSecurity {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .httpBasic().disable()
                .authorizeRequests()
                .requestMatchers("/auth/register", "/auth/login","/auth/validateToken").permitAll()
                .and()
                .csrf(csrf -> csrf.csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse()).ignoringRequestMatchers("/auth/login","/auth/register","/auth/validateToken","*"))
...
//        cors_config.setAllowedHeaders(List.of("Access-Control-Allow-Origin", "Content-Type", "Accept", "X-Requested-With", "remember-me"));
//
//        UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
//        source.registerCorsConfiguration("/**", cors_config);
//
//        return  request -> {
//            System.out.println("Origin: " + request.getHeader("Origin")); // Log the incoming request's origin
//            return cors_config;
//        };
//    }
