...
import com.ajaksmaniac.streamify.notifications.controller.WebSocketController;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        ...
        registry.addHandler(new WebSocketController(userService,notificationService), "/notifications").setAllowedOrigins("*");
    }
}